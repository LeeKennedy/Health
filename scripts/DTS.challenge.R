...
plot_wt <- ggplot(weight2, aes(Date,Weight)) + 
                geom_rect(aes(ymin = 85, ymax = 87, xmin = weight2$Date[1], xmax = weight2$Date[397]), fill = "grey80") +
                geom_rect(aes(ymin = 87, ymax = 88, xmin = weight2$Date[1], xmax = weight2$Date[397]), fill = "grey90") +
